...
合计: **28,687** 行代码（覆盖前 5 种语言、共 **574** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 28,292 | 95 | 4,105 | 570 |
| Toml | 204 | 0 | 14 | 2 |
| Sh | 191 | 12 | 30 | 1 |
| Markdown | 0 | 134 | 51 | 1 |
...
- **Star**: 3,121 · **Fork**: 93 · **开放 issue**: 96 · **贡献者**: 21

## 累计统计

- **发布数**: 38 · **已合并 PR**: 23 · **开放 PR**: 3 · **已关闭 issue**: 82 · **开放 issue**: 14 · **提交数**: 1504

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 2 | 1 | 1 | 2 | 2 | 117 |
| last60d | 2026-07-27 | 3 | 2 | 1 | 2 | 3 | 152 |
| 90d | 2026-06-27 | 4 | 2 | 2 | 3 | 4 | 293 |
| last180d | 2026-03-29 | 6 | 3 | 3 | 6 | 10 | 383 |
| 360d | 2025-09-30 | 8 | 9 | 3 | 14 | 12 | 844 |
| last720d | 2024-10-05 | 22 | 19 | 3 | 73 | 14 | 1248 |
...
tabiew 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `tabiew` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/tabiew.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:01:20Z._
